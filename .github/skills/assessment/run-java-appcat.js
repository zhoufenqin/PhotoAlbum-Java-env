...
// ----------------------------------------------------------------------------
// AppCAT discovery — the skill downloads + extracts AppCAT into ~/.appcat;
// this script only locates the launcher under it.
// ----------------------------------------------------------------------------
...
async function main() {
  ...
  const executable = findAppcatExecutable(appcatHome, osName);
  if (!executable) {
